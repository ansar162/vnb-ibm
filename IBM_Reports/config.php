...
define('SW_PROJECT_PASSWORD','IBM');
...
define('SW_PROJECT_TITLE','IBM Reports');
...
define('SW_DB_USER','ibmuser');
define('SW_DB_PASSWORD','ibmuser123');
define('SW_DB_HOST','127.0.0.1');
define('SW_DB_DATABASE','ibmdb_new');
